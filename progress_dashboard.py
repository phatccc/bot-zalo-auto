...
<script>
const route=location.pathname,content=document.querySelector('#content'),nav=document.querySelector('#nav'),summary=document.querySelector('#summary');let open=new Set(),itemsOpen=new Set(),last={};
